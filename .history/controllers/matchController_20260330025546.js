...
exports.createMatch = async (req, res) => {
  try {
    ...
    const [result] = await db.execute(
      `INSERT INTO MatchSport (sport_id, createur_id, titre, date_heure, localisation, nb_joueurs_max, nb_equipe_a, nb_equipe_b, nb_remplacants, nom_equipe_a, nom_equipe_b)
   VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)`,
      [
        sport_id,
        req.user.id,
