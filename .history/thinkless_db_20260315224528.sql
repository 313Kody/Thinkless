...
CREATE DATABASE IF NOT EXISTS thinkless
...
CREATE TABLE ResultatMatch (
  ...
  elo_delta       SMALLINT      NOT NULL DEFAULT 0,  -- pts gagnés/perdus
...
-- ============================================================
CREATE INDEX idx_match_sport_statut    ON Match(sport_id, statut);
